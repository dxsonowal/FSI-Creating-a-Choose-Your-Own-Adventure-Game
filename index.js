...
Do you follow it, or continue on your path?`)
    if (secondAnswer === 'follow it') {
        let secondAnswer = window.prompt('You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven. Do you want to stay or spread the word ')
...
lead you away from the dragon altogether. Which path do you take, Past or Away ?`)
    if (secondAnswer === 'Past'){
        ...
        if (thirdAnswer === 'stay') {
            ...
            window.prompt ('Quickly, you run back to the caves entrance. Sheepish, you return home.')
        }
